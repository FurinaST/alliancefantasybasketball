/*   STEP 1   */
export const leagueID = "1149456793530359808"; // your league ID
export const leagueName = "Alliance Basketball Association"; // your league name
...
export const homepageText = `
  <p>The Alliance of Fantasy is a multi-league, multi-sport association that offers fantasy sports for over 64 unique franchises, spread all around the entire globe.</p>
